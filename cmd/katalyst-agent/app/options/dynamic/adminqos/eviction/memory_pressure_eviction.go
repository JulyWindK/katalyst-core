...
func (o *MemoryPressureEvictionOptions) AddFlags(fss *cliflag.NamedFlagSets) {
	...
	fs.StringSliceVar(&o.EvictAnnotationSelector, "eviction-memory-annotation-selector", o.EvictAnnotationSelector,
		"the annotation selector used to filter pods for eviction")
	fs.StringSliceVar(&o.EvictLabelSelector, "eviction-memory-label-selector", o.EvictLabelSelector,
