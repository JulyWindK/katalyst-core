...
func (o *IRQCoresExclusionOptions) AddFlags(fss *cliflag.NamedFlagSets) {
	...
	fs.Float64Var(&o.SuccessiveSwitchInterval, "irq-cores-exclusion-successive-switch-interval", o.SuccessiveSwitchInterval, "interval of successive enable/disable irq cores exclusion MUST >= SuccessiveSwitchInterval")
