...
func (o *IRQCoresExclusionThresholdOptions) AddFlags(fss *cliflag.NamedFlagSets) {
	...
	fs.Uint64Var(&o.EnableThresholds.RxPPSThresh, "irq-cores-exclusion-enable-thresholds-rxpps-thresh", o.EnableThresholds.RxPPSThresh, "irq cores exclusion enable thresholds rxpps thresh")
	fs.IntVar(&o.EnableThresholds.SuccessiveCount, "irq-cores-exclusion-enable-thresholds-successive-count", o.EnableThresholds.SuccessiveCount, "irq cores exclusion enable thresholds successive count")
	fs.Uint64Var(&o.DisableThresholds.RxPPSThresh, "irq-cores-exclusion-disable-thresholds-rxpps-thresh", o.DisableThresholds.RxPPSThresh, "irq cores exclusion disable thresholds rxpps thresh")
	fs.IntVar(&o.DisableThresholds.SuccessiveCount, "irq-cores-exclusion-disable-thresholds-successive-count", o.DisableThresholds.SuccessiveCount, "irq cores exclusion disable thresholds successive count")
}
