...
func (o *IRQLoadBalanceOptions) AddFlags(fss *cliflag.NamedFlagSets) {
	...
	fs.IntVar(&o.IRQsTunedNumMaxEachTime, "irqs-tuned-num-max-each-time", o.IRQsTunedNumMaxEachTime, "max number of irqs are permitted to be tuned from some irq cores to other cores in each time, allowed value {1, 2}")
