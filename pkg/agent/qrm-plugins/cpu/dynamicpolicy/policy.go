...
func NewDynamicPolicy(agentCtx *agent.GenericContext, conf *config.Configuration,
	...
	// TODO(KFX): ensure
	irqTuner, err := irqtuingcontroller.NewIrqTuningController(conf.AgentConfiguration.DynamicAgentConfiguration, policyImplement, policyImplement.emitter, policyImplement.machineInfo)
	if err != nil {
