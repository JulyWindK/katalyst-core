...
type DynamicConfigCRD struct {
	...
	// TODO(KFX): irq
	IrqAffinityConfiguration *v1alpha1.TransparentMemoryOffloadingConfiguration
}
...
var (
	...
	// TODO(KFX): irq
	// IrqAffinityConfigurationGVR = metav1.GroupVersionResource(v1alpha1.SchemeGroupVersion.WithResource(v1alpha1.ResourceNameIrqAffinityConfigurations))
)
